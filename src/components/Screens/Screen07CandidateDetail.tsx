        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-100">
          <div>
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-slate-900 text-sm">
                Historical Outcomes &amp; Impact Evidence ({area.name})
              </h3>
            </div>
            <p className="text-xs text-slate-500 mt-0.5">
              Verified record of previous SERVEON algorithmic recommendations, actual capital investments, targets, and empirical outcome ROI in this area.
            </p>
          </div>
          ...
          <div className="flex items-center gap-2 self-start sm:self-auto">
            <button
              ...
              className="px-3 py-1.5 rounded-lg bg-emerald-700 hover:bg-emerald-800 text-white text-xs font-bold transition-colors flex items-center gap-1.5 cursor-pointer shadow-2xs"
            >
              <Activity className="w-3.5 h-3.5" />
              <span>Explore Outcome Map</span>
            </button>
            <button
          ...
          const historyRecords = [
            {
              ...
              investment: `Rp${(impact.actualInvestment / 1000000).toFixed(0)}M`,
              target: '78.0%',
              actual: `${impact.treatmentAfter}%`,
              impact: `+${impact.incrementalEffect} ppt`,
              businessValue: `Rp${(impact.businessBenefit / 1000000).toFixed(0)}M`,
              roi: `+${impact.roi}%`,
              outcome: impact.outcomeStatus,
              pillBg: style.pillBg,
            },
            {
              period: 'Q2 2026',
              ...
              actual: '75.5%',
              impact: '+3.5 ppt',
              businessValue: 'Rp110M',
              roi: '+175%',
              outcome: 'POSITIVE OUTCOME' as const,
              pillBg: 'bg-emerald-100 text-emerald-800 border border-emerald-300',
            },
          ];
              ...
              <table className="w-full text-left text-xs">
                <thead className="bg-slate-50 text-slate-500 text-[10px] font-bold uppercase border-b border-slate-200">
                  <tr>
                    ...
                    <th className="px-3 py-2.5 text-right">Business Value</th>
                ...
                <tbody className="divide-y divide-slate-100">
                  {historyRecords.map((hist, idx) => (
                    <tr key={idx} className="hover:bg-slate-50/80">
                      ...
                      <td className="px-3 py-3 font-bold text-slate-800 text-[10px] uppercase">
                        {hist.objective}
                      </td>
                      ...
                      <td className="px-3 py-3 text-center">
                        <span className={`inline-flex px-2 py-0.5 rounded text-[10px] font-bold ${hist.pillBg}`}>
                          {hist.outcome}
                        </span>
                      </td>
                    </tr>
